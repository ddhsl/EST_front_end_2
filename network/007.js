// 회원가입
fetch("https://eduapi.weniv.co.kr/228/signup", {
    method: "POST",
    headers: {
...
// 로그인
fetch("https://eduapi.weniv.co.kr/228/login", {
    method: "POST",
    headers: {
        "Content-Type": "application/json",
    },
...
// 블로그 글 가져오기 - GET
fetch('https://eduapi.weniv.co.kr/228/blog')
    .then(response => response.json())
    .then(json => console.log(json))
    .catch(error => console.error(error));
...
// 글 상세 목록 - GET
fetch('https://eduapi.weniv.co.kr/228/blog/1')
    .then(response => response.json())
    .then(json => console.log(json))
    .catch(error => console.error(error));
